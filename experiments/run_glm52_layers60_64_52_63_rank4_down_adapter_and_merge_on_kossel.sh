...
for layer in 60 64 52 63; do
  ...
  slice_stem="glm52-layer${layer}-frozen8-low-rank-down-reconstructed-activation-refit-bf16-rank-4-slice"
  merged_name="glm52-layer${layer}-frozen8-low-rank-down-reconstructed-activation-refit-bf16-rank-4-merged"
