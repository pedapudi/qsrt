...
container = json.loads(Path("/home/sunil/qsrt-glm52-experiments/launch-records/glm52-layer3-frozen8-uniform-k3-kld-lower-memory/container-before-start-inspect.json").read_text())[0]
