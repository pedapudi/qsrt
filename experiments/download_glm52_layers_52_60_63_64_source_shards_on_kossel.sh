...
# Download only the official BF16 shards containing routed-expert tensors for
# GLM-5.2 layers 52, 60, 63, and 64. Each completed shard must match the
# immutable Hugging Face SHA-256 identity before it becomes visible without a
# .partial suffix.
...
manifest="${script_root}/glm52_layers_52_60_63_64_source_shards.json"
destination="${experiment_root}/source-windows/glm52-b4734de-layers-52-60-63-64"
revision="b4734de4facf877f85769a911abafc5283eab3d9"
expected_shards=17
expected_bytes=91142336944
parallel_downloads=4
lock_file="${experiment_root}/locks/glm52-layers-52-60-63-64-source-download.lock"
